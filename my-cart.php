...
if(isset($_POST['submit'])){
		...
		foreach($_POST['quantity'] as $key => $val){
			...
			echo "<script>alert('Tu carrito se ha actualizado!');</script>";
		}
	}
// para remover un item de carrito
...
// aqui es para insertar un producto en la tabla
				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class=""> <!-- boton seguir comprando -->
...
$_SESSION['sid']=$pd;
						 ?></a></h4> <!-- ======== Seccion para el rating del producto ==== -->
						<div class="row">
							<div class="col-sm-4">
...
$_SESSION['pid']=$pdtid;
	...
	<table class="table table-bordered">
		...
		<tbody>
				<tr>
					<td> <!-- ======== tomamos las direcciones del usuario para enviarle el producto ====== -->
