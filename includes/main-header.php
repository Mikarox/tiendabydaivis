...
<!-- Codigo sql para llevar el control de lo que se agrega al carrito -->
		 <?php
...
<!-- =================== Sección donde se ve el total del carrito y el icono =================== -->
<?php } else { ?>
<div class="dropdown dropdown-cart">
		<a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
			<div class="items-cart-inner">
		...
		<!-- Seccion donde al desplegar el menu del carrito dice el sig mensaje y el boton de seguir comprando -->
		<ul class="dropdown-menu">
			<li>
				<div class="cart-item product-summary">
					<div class="row">
