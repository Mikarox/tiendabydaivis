							...
							<div class="product-social-link m-t-20 text-right">
								...
								<div class="social-icons">
						            <ul class="list-inline">
						                ...
						                <li><a class="fa fa-twitter" href="https://twitter.com/?lang=es"></a></li>
						                <li><a class="fa fa-pinterest" href="https://www.pinterest.com.mx/"></a></li>
						            </ul>
						        </div>
							</div>	
						</div>
...
<?php $cid=$row['category'];
			$subcid=$row['subCategory']; } ?>
				<!-- ========================= productos en venta similares al producto que le intereso al cliente ============================== -->
